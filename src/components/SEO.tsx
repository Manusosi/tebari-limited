...
const SEO: React.FC<SEOProps> = ({
  title = 'Tebari',
  description = 'Tebari Limited: Transforming plastic waste into sustainable solutions, pioneering circular economy in Kenya.',
  type = 'website',
  name = 'Tebari Limited',
  ...
  author,
  category,
  keywords = ['plastic recycling', 'circular economy', 'sustainable solutions', 'waste management', 'Kenya', 'blue economy'],
  isBlogPost = false
}) => {
  const location = useLocation();
  const currentUrl = `https://tebari.com${location.pathname}`;
  const absoluteImageUrl = imageUrl.startsWith('http') ? imageUrl : `https://tebari.com${imageUrl}`;
  ...
  const organizationStructuredData = {
    ...
    '@type': 'Organization',
    name: 'Tebari Limited',
    url: 'https://tebari.com',
    logo: 'https://tebari.com/lovable-uploads/526dc38a-25fa-40d4-b520-425b23ae0464.png',
    description: 'Transforming plastic waste into sustainable solutions for circular economy',
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer service',
      email: 'hello@tebari.co.ke'
    },
    sameAs: [
      'https://www.linkedin.com/company/tebari-limited',
      'https://twitter.com/tebarilimited'
    ]
  };
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://tebari.com/lovable-uploads/526dc38a-25fa-40d4-b520-425b23ae0464.png',
        width: 512,
        height: 512
      },
      url: 'https://tebari.com'
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Tebari Limited" />
      <meta property="og:locale" content="en_US" />
      {isBlogPost && category && <meta property="article:section" content={category} />}
      {isBlogPost && publishDate && <meta property="article:published_time" content={publishDate} />}
      {isBlogPost && modifiedDate && <meta property="article:modified_time" content={modifiedDate} />}
      {isBlogPost && <meta property="article:publisher" content="https://tebari.com" />}
      ...
      <meta name="twitter:site" content="@tebarilimited" />
      <meta name="twitter:creator" content="@tebarilimited" />
