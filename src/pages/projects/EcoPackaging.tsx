...
const EcoPackaging = () => {
  return (
    <PageLayout>
      <SEO 
        title="Eco-Packaging Solutions - Coming Soon | Tebari Limited"
        description="Sustainable packaging from recycled materials - Coming Soon"
      />
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-tebari-green/10 to-white">
        <div className="text-center px-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Our sustainable packaging solutions made from recycled materials 
