...
const ContactInfo = () => {
  return (
    <section id="contact-info" className="bg-gradient-to-b from-white to-tebari-green text-white relative py-[15px] md:py-[25px]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 md:mb-16">
          <div className="inline-block mb-3 px-3 py-1 bg-white text-tebari-green rounded-full text-sm font-medium">
            Get In Touch
          </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-xl shadow-xl p-6 md:p-8 border border-gray-700 max-w-md mx-auto">
            ...
            <div className="flex flex-col space-y-3">
              <a href="mailto:info@tebari.net" className="flex items-center justify-center text-gray-700 hover:text-tebari-green">
                <Mail className="w-5 h-5 mr-2" />
                info@tebari.net
              </a>
