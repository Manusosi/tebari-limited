                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[
                    ...
                    },
                    {
                      ...
                      bio: "Managing Tebari's financial operations and ensuring sustainable, transparent growth.",
                      email: "felix@tebari.net",
                      image: "/lovable-uploads/felix-aluoch-finance.png"
                    },
                    {
                      name: "Emanuel Soita",
                      role: "Product Development Lead",
                      bio: "Leading product development and R&D for recycling technologies and new product lines.",
                      email: "developer@tebari.net",
                      image: "/lovable-uploads/emanuel-soita-product.png"
                    }
                  ].map((member, i) => (
