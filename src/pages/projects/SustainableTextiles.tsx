...
const SustainableTextiles = () => {
  return (
    <PageLayout>
      <SEO 
        title="Sustainable Fashion Textiles - Coming Soon | Tebari Limited"
        description="Plastic-to-fabric conversion technology - Coming Soon"
      />
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-tebari-green/10 to-white">
        <div className="text-center px-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Our plastic-to-fabric conversion technology for sustainable fashion 
...
export default SustainableTextiles;
