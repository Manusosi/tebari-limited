...
import { Users, Recycle, Wrench, BookOpen, ArrowRight, Box, Truck, Code, CheckCircle, Rocket, Factory, Microchip, Handshake, RefreshCcw, MessageSquare, ExternalLink } from "lucide-react";
...
const Features = () => {
  ...
  const features = [
    {
      ...
      image: "/gallery/plastic-collection/WhatsApp Image 2025-10-28 at 6.33.45 PM.jpeg"
    },
    {
      icon: <Recycle className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Digital Waste Tracking",
      description: "Our tebari.cloud platform allows field officers to locate plastic hotspots via GPS, then sort, weigh, and track collection in real-time.",
      image: "/gallery/plastic-collection/WhatsApp Image 2025-10-28 at 6.33.47 PM (2).jpeg"
    },
    {
      ...
      image: "/gallery/plastic-collection/WhatsApp Image 2025-10-28 at 6.33.48 PM (2).jpeg"
    },
    {
  ...
  const sensorCaseStudies = [{
    ...
    image: "/gallery/plastic-collection/WhatsApp Image 2025-10-28 at 6.33.48 PM.jpeg",
    title: "Plastic collection point",
    description: "well sorted plastics ready for collection by recyclers"
  }, {
  ...
  const stepFlowItems = [{
    ...
    icon: <Microchip className="h-10 w-10 text-tebari-green" />,
    title: "tebari.cloud Tech",
    description: "Our proprietary platform maps plastic hotspots in real-time. Field officers locate waste via GPS, sort and weigh it on-site before moving it to collection points for recycler pick-up."
  }, {
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <a
              href="https://tebari.cloud"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-4 sm:px-6 py-3 bg-tebari-green hover:bg-tebari-green/90 text-white rounded-lg shadow-md hover:shadow-lg transition-all group w-full sm:w-auto justify-center font-medium"
            >
              View Product
